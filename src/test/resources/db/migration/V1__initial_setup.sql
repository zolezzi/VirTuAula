...
create table task(id bigint primary key AUTO_INCREMENT, statement varchar(255) not null,lesson_id bigint, constraint fk_task_lesson FOREIGN KEY (lesson_id) REFERENCES lesson(id));