...
public class VirtuaulaApplicationTests {
    ...
    @Autowired
    protected ClassromRepository guestClassroomRepository;
    ...
    protected Lesson createTask(Classroom classroom, String statement, Long correctAnswer) {
        Task task = new Task(statement, correctAnswer);
