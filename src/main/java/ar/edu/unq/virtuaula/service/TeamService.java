...
public class TeamService {
    ...
    public void addToTeam(NewGame newGame, LeaderAccount leaderAccount, List<PlayerAccount> players) {
        Team teamBD = teamRepository.findByNewGame(newGame);
        players.forEach(player -> teamBD.addPlayer(player));
        teamRepository.save(teamBD);
    }
