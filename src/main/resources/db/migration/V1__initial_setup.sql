...
create table task(id bigint primary key AUTO_INCREMENT, statement varchar(255) not null, answer bigint, correct_answer bigint, score double(10,2), lesson_id bigint, constraint fk_task_lesson FOREIGN KEY (lesson_id) REFERENCES lesson(id));
