...
create table lesson(id bigint primary key AUTO_INCREMENT, name varchar(255) not null, max_note double(10,2), classroom_id bigint, delivery_date DATETIME, constraint fk_lesson_classroom FOREIGN KEY (classroom_id) REFERENCES classroom(id));
