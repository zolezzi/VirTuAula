...
create table task(id bigint primary key AUTO_INCREMENT, statement varchar(255) not null, state varchar(15) default 'UNCOMPLETED', answer bigint, correct_answer bigint not null, score double(10,2), lesson_id bigint, constraint fk_task_lesson FOREIGN KEY (lesson_id) REFERENCES lesson(id));
...
create table account(id bigint primary key AUTO_INCREMENT, username varchar(255), firstName varchar(255), lastName varchar(255), email varchar(255), account_type_id bigint, account_type_role varchar(255), experience double(20,2), user_id bigint, constraint fk_account_type FOREIGN KEY (account_type_id) REFERENCES account_type(id), constraint fk_account_user FOREIGN KEY (user_id) REFERENCES user(id));
